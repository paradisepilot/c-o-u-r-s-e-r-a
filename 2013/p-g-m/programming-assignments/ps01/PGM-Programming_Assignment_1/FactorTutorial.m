...
computed.FACTORS.PRODUCT = FactorProduct(FACTORS.INPUT(1), FACTORS.INPUT(2));

disp("#########################");
disp("FACTORS.PRODUCT");
disp( FACTORS.PRODUCT );
disp("computed.FACTORS.PRODUCT");
disp( computed.FACTORS.PRODUCT );

% Factor Marginalization
FACTORS.MARGINALIZATION = struct('var', [1], 'card', [2], 'val', [1 1]); 
computed.FACTORS.MARGINALIZATION = FactorMarginalization(FACTORS.INPUT(2), [2]);

disp("#########################");
disp("FACTORS.MARGINALIZATION");
disp( FACTORS.MARGINALIZATION );
disp("computed.FACTORS.MARGINALIZATION");
disp( computed.FACTORS.MARGINALIZATION );
...
computed.FACTORS.MARGINAL = ComputeMarginal([2, 3], FACTORS.INPUT, [1, 2]);

disp("#########################");
disp("FACTORS.MARGINAL");
disp( FACTORS.MARGINAL );
disp("computed.FACTORS.MARGINAL");
disp( computed.FACTORS.MARGINAL );
