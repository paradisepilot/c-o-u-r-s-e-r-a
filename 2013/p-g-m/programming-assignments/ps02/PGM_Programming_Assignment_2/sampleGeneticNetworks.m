...
disp("sampleFactorListDecoupled");
disp( sampleFactorListDecoupled );
...
%disp("computedSampleFactorListDecoupled(1)");
%disp( computedSampleFactorListDecoupled(1) );
%disp("computedSampleFactorListDecoupled(2)");
%disp( computedSampleFactorListDecoupled(2) );
%disp("computedSampleFactorListDecoupled(3)");
%disp( computedSampleFactorListDecoupled(3) );
